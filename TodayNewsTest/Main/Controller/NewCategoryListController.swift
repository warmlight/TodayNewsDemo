//
//  NewCategoryListController.swift
//  TodayNewsTest
//
...
class NewCategoryListController: UITableViewController {
    var lastSelectedTabIndex: Int?
    var topCategoryTitle: CategoryTitle?
...
extension NewCategoryListController {
